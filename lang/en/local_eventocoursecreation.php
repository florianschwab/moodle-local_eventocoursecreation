...
$string['idnumber_help'] = 'Course of studies, which is stored in the cateogry ID.';
$string['longcoursenaming'] = 'Long name for moodle courses';
$string['longcoursenaming_help'] = 'Defines the long name for courses. Available tokens are: (Evento module name: @EVENTONAME@; Evento module abrevation: @EVENTOABK@; Term period: @PERIODE@; Course of studies: @STG@)';
