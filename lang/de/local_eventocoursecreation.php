...
$string['longcoursenaming_help'] = 'Definiert den langen Namen für Kurse. Verfügbar sind folgende Tokens: (Evento Module Name: @EVENTONAME@; Evento Module Abkürzung: @EVENTOABK@; Semesterperiode: @PERIODE@; Studiengang: @STG@)';
...
$string['templatecourse_help'] = 'Kursvorlage vom welchem die Inhalte übernommen werden. Wenn keine Vorlage gesetzt ist, werden leere Kurse erstellt.';
